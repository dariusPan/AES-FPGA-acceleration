...
HD_PWD='C:/Users/Darius/Desktop/Y4S1/EE4218/AES_package/AES_package.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AES_InvCipher_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AES_InvCipher_v1_0.tcl -notrace
